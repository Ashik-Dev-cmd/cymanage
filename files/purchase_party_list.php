...
$sql = "SELECT * FROM parties WHERE type = 'Purchase'";
        ...
        <div class="party-list">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<a class="party-name" href="purchase_details.php?party_id=' . htmlspecialchars($row['id']) . '">' . htmlspecialchars($row['name']) . '</a>';
                    echo '</div>';
                }
            } else {
